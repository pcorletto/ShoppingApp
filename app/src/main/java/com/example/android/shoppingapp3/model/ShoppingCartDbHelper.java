...
public class ShoppingCartDbHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_QUERY = "CREATE TABLE " + ShoppingCartDB.NewCartItem.TABLE_NAME +
            ...
            ShoppingCartDB.NewCartItem.IMAGE + " TEXT," +
            ShoppingCartDB.NewCartItem.TAXABLE + " TEXT);";
    ...
    public void addItem(String upc, int quantity, int last_quantity, String last_date_purchased,
        ...
        contentValues.put(ShoppingCartDB.NewCartItem.IMAGE, image);
        contentValues.put(ShoppingCartDB.NewCartItem.TAXABLE, taxable);
    ...
    public Cursor getCartItem(SQLiteDatabase db){
        ...
        String[] projections = {ShoppingCartDB.NewCartItem.UPC_CODE,
                ...
                ShoppingCartDB.NewCartItem.IMAGE,
                ShoppingCartDB.NewCartItem.TAXABLE};
    ...
    public Cursor sortCartItemsByName(SQLiteDatabase db){
    ...
    public Cursor sortCartItemsByPriority(SQLiteDatabase db){

        Cursor cursor;

        cursor = db.rawQuery("SELECT * FROM " + ShoppingCartDB.NewCartItem.TABLE_NAME +
                " ORDER BY " + ShoppingCartDB.NewCartItem.PRIORITY + " DESC", null);
